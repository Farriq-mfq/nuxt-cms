...
<template>
    <section v-if="albumsList.length" class="bg-surface-container-low py-xl">
        <div class="max-w-7xl mx-auto px-margin">
            <div class="flex items-end justify-between mb-md">
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <h2 class="text-headline-lg text-on-surface mt-1">Galeri Kegiatan</h2>
                    </div>
                </div>
                <NuxtLink to="/galeri"
            ...
            <div class="flex flex-col gap-3 lg:grid lg:grid-cols-4 lg:grid-rows-2 lg:gap-4 lg:aspect-[14/7]">
                <NuxtLink v-if="featured" :to="`/galeri/${featured.slug}`"
                    ...
                    <Icon name="lucide:images" size="18"
                        class="hidden lg:block absolute top-3 right-3 text-white z-10" />
            ...
            <div class="sm:hidden mt-md text-center">
                <NuxtLink to="/galeri"
                    class="inline-flex items-center gap-1 text-body-md text-secondary hover:underline">
                    Lihat Semua Album
                    <Icon name="lucide:arrow-right" size="16" />
                </NuxtLink>
            </div>
