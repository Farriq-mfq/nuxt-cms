...
<template>
    <section v-if="banners.length">
        <PublicContainer>
            <div class="grid lg:grid-cols-[minmax(0,420px)_1fr] min-h-[420px] lg:min-h-[480px] bg-primary"
                    ...
                    <div>
                        ...
                        <transition mode="out-in" enter-active-class="transition duration-300 ease-out"
                            ...
                            <div :key="activeIndex" class="mt-4">
                                ...
                                <a v-if="banners[activeIndex].linkUrl" :href="banners[activeIndex].linkUrl!"
                                    target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 mt-6 bg-secondary text-on-secondary rounded px-5
                ...
                <div class="relative order-1 lg:order-2 overflow-hidden min-h-[240px]">
                    <transition mode="out-in" enter-active-class="transition duration-500 ease-out"
                        ...
                        leave-to-class="opacity-0">
                        <img v-if="banners[activeIndex].image" :key="activeIndex"
                            :src="banners[activeIndex].image!.path" :alt="banners[activeIndex].title"
