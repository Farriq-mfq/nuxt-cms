...
const {
    ...
    confirmFn: deletePostCategories,
    confirmHeader: "Hapus Kategori Post",
...
<template>
    <div class="space-y-md">
        <div class="flex items-center justify-between">
            <h1 class="text-headline-lg">Kategori Post</h1>
        </div>
        <AdminDataTable ref="tableRef" endpoint="/api/_admins/posts-categories" :columns="columns"
            :search-placeholder="'Cari Kategori Post...'" row-key="id">
            <template #toolbar>
